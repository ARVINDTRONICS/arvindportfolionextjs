                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] ">
                  <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                    ...
                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600  text-left">
                      ...
                      for online check-in <span className="font-bold ">(first in the UAE region in hospitality industry)</span>that uses OCR- recognition capabilities to scan documents and Facial recognition for guest validation, thus streamlining
                      the check-in process and improving guest experience.
                    </p>
                  </div>
              ...
              <div className="relative lg:row-span-1 lg:col-span-3">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                  <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                    ...
                    <p className="mt-2 min-w-lg text-sm/6 text-gray-600 text-left">Personalized travel concierge application for a major lifestyle bank that serves their premium customers</p>
                  </div>
                  <div className="relative min-h-[20rem] lg:min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
