        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex flex-col items-center">
            <div className="text-center">
              <p className="text-lg font-medium text-gray-600 font-pj">If you are the one who likes to hear from other people </p>
                    ...
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-sm leading-relaxed text-gray-900 font-pj">
                          “Arvind is one of the youngest members on the team but his clarity of thought and maturity set him apart. He has been very diligent in completing the tasks assigned to him on time and with no compromise on quality. A very
                          dependable and valued team member, his attention to detail and understanding the solution end to end are note worthy. Excellent team player who in many occasions has volunteered to take up additional tasks during project
                          exigencies.Arvind is a quick learner indeed. He not only learnt to survive but thrive in the wild west.”
                        </p>
                      </blockquote>
                    </div>
                ...
                <div className="flex flex-col overflow-hidden shadow-xl">
                  <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-sm leading-relaxed text-gray-900 font-pj">
                          “Arvind is a fast learner. He always has positive attitude and good team spirit. He always loves to take complex tasks and work through it. He loves to explore new things(practically). We were in a critical situation when he
                          joined, he handled it well, even though he was new to React.”
                        </p>
                      </blockquote>
                    </div>
                ...
                <div className="flex flex-col overflow-hidden shadow-xl">
                  <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-sm leading-relaxed text-gray-900 font-pj">“LEAP AWARD 🏆 A fantastic newbie who delivered exceptional work and goes Above & Beyond in delivering exemplary service.”</p>
                      </blockquote>
                    </div>
                ...
                <div className="flex flex-col overflow-hidden shadow-xl">
                  <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-sm leading-relaxed text-gray-900 font-pj">“Appreciate the delivery excellence and the determination to improve business process”</p>
                      </blockquote>
                    </div>
